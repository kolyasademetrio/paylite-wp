...
function custom_scripts()
{
  ...
  wp_register_script('jquery', get_template_directory_uri() . '/js/jquery-3.0.0.min.js', NULL, NULL, true);
  wp_enqueue_script('jquery');

  wp_register_script('slick-slider', get_template_directory_uri() . '/js/slick.js', array('jquery'), NULL, true);
  wp_enqueue_script('slick-slider');

  wp_register_script('jquery-migrate', get_template_directory_uri() . '/js/jquery-migrate-1.4.1.min.js', array('jquery'), NULL, true);
  wp_enqueue_script('jquery-migrate');

  wp_register_script('magnific-popup', get_template_directory_uri() . '/js/magnific-popup.min.js', array('jquery'), NULL, true);
